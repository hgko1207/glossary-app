package com.hgko.glossary.config;
...
import com.hgko.glossary.provider.SaveIdLoginSuccessHandler;
import com.hgko.glossary.provider.UserAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests() // 요청을 어떻게 보안을 할 것인지 설정
			...
			.antMatchers("/word/**").access("hasRole('ROLE_USER')")
			.antMatchers("/term/**").access("hasRole('ROLE_USER')")
		.and()
